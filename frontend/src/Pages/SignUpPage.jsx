              ...
              >
                <div className="mb-4 flex flex-col gap-6">
                  <div className="relative h-11 w-full min-w-[200px]">
                    <input
                      className="peer h-full w-full rounded-md border border-color1 bg-transparent px-3 py-3 font-sans text-sm font-normal text-color1 outline outline-0 transition-all focus:ring-0 placeholder-shown:border focus:border-2 focus:border-color4 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-pink-500"
                      placeholder=" "
                      type="text"
