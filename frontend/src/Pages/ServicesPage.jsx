  ...
  return (
    <Card>
      ...
      <ul className='flex items-start justify-between px-4 py-4 gap-8 mt-10 md:flex-row flex-col'>
        ...
        <li className="w-full lg:w-[32%] px-10 pt-16 pb-8 bg-color3 bg-opacity-60 rounded-lg self-stretch hover:scale-105 hover:shadow-[0px_14px_28px_-5px_rgba(0,0,0,0.1)] transition-all duration-150 ease-in relative group">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 rounded-br-xl rounded-bl-xl bg-color5 text-color1 px-8 py-2 group-hover:bg-red-800 group-hover:text-white transition-all duration-150 ease-in group-hover:shadow-[0px_14px_28px_-5px_rgba(0,0,0,0.1)]">
            Sold Out
          </div>
          <h2 className="text-center font-semibold text-lg tracking-wider mb-3 drop-shadow-[3px_3px_5px_rgba(91,91,91,0.58)]">
            Premium Sidebar
